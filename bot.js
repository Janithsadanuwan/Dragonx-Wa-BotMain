...
// ════════════════════WA CONNECTION🍁🍁🍁
    ...
    conn.browserDescription = ["DRAGONX", "Safari", '4.0.0']
...
// ════════════════════PLUGGINS SUCCESS🍁🍁🍁
        console.log(
            chalk.green.bold(' ⎝🛡️ DRAGON 🛡️⎠ WHATSAPP BOT WORKING!▷')
       );
        
        console.log(
            chalk.blueBright.italic('⎝🛡️ DRAGON 🛡️⎠ WhatsApp User Bot v4.0.0')
        );
    ...
    setInterval(async () => { 
        if (config.AUTOBIO == 'true') {
            if (conn.user.jid.startsWith('90')) { 
                ...
                const biography = '📅 ' + utch + '\n⌚ ' + ov_time + '\n\nPOWERD BY ⎝🛡️ DRAGONX 🛡️⎠ WhatsApp User Bot '
