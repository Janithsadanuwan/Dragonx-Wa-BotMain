...
Trex.addrex({pattern: 'video ?(.*)', fromMe: true, desc: 'hu'}, (async (message, match) => { 
    ...
    Trex.addrex({ pattern: 'insta ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.IG_DESC}, (async (message, match) => {
      ...
      if (msg === '200') {
        ...
        await message.sendMessage(Buffer.from(profileBuffer.data), MessageType.video, {caption: "⎝🛡️ Dragonx 🛡️⎠ "}) 
        }
          })
          .catch(
    ...
    Trex.addrex({ pattern: 'insta ?(.*)', fromMe: false, desc: Lang.IG_DESC}, (async (message, match) => {
      ...
      if (msg === '200') {
        ...
        await message.sendMessage(Buffer.from(profileBuffer.data), MessageType.video, {quoted: message.data}, {caption: "⎝🛡️ Dragonx 🛡️⎠ "}) 
        }
          })
          .catch(
