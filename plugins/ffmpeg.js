Dragon-xJanith/* Copyright (C) 2021 Trex.
    ...
    Trex.addrex({pattern: 'ffmpeg ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.FF_DESC}, (async (message, match) => {
        ...
        if (message.reply_message.video) {
            ...
            ffmpeg(location)
                ...
                .save('Dragonx.mp4')
                .on('end', async () => {
                    await message.sendMessage(fs.readFileSync('Dragonx.mp4'), MessageType.video, {mimetype: Mimetype.mpeg, caption: '⎝🛡️ Dragonx 🛡️⎠'});
                });
            ...
            ffmpeg(location)
                ...
                .save('Dragonx.jpg')
                .on('end', async () => {
                    await message.sendMessage(fs.readFileSync('Dragonx.jpg'), MessageType.image, {mimetype: Mimetype.jpg, caption: '⎝🛡️ Dragonx 🛡️⎠'});
                });
            return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
        }
        else {
            ...
            ffmpeg(location)
                ...
                .save('Dragonx.mp3')
                .on('end', async () => {
                    await message.sendMessage(fs.readFileSync('Dragonx.mp3'), MessageType.audio, {mimetype: Mimetype.mp4Audio});
                });
            return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
        }
    }));
