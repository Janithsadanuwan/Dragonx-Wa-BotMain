...
module.exports = {
    ...
    SESSION: process.env.DRAGONX_SESSION === undefined ? '' : process.env.DRAGONX_SESSION,
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'Dragon X' : process.env.OWNER_NAME,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://telegra.ph/file/35883180004518cb15fe9.jpg' : process.env.ALIVE_LOGO,
    ...
    GROUPN1: process.env.GROUP_DETAILS === undefined ? 'Dragon X OFFICIAL SUPPORT': process.env.GROUP_DETAILS,
    GROUPL1: process.env.GROUP_LINK_1 === undefined ? 'https://chat.whatsapp.com/LhWT3s3koJx6kkUROPtUeD': process.env.GROUP_LINK_1,
    GROUPN2: process.env.GROUP_NAME_2 === undefined ? 'Dragon X OFFICIAL TEST': process.env.GROUP_NAME_2,
    GROUPL2: process.env.GROUP_LINK_2 === undefined ? 'https://chat.whatsapp.com/LhWT3s3koJx6kkUROPtUeD': process.env.GROUP_LINK_2,
    ...
    CAPTION: process.env.CAPTION === undefined ? ' ⎝🛡️ Dragon X 🛡️⎠ ' : process.env.CAPTION,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'DRAGONX' : process.env.BOT_NAME,
    ...
    TREX: process.env.TREX === undefined ? 'Dragon X' : process.env.TREX,
    ...
    KTB: process.env.TAG_HEADER === undefined ? 'Dragon X' : process.env.TAG_HEADER,
